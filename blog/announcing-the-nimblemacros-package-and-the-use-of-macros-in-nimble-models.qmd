...
Developers can use the tools in `nimble` itself to create their own macros. See [Section 12.4 of the NIMBLE user manual](https://web.archive.org/web/20250427235758/https://r-nimble.org/html_manual/cha-user-defined.html#sec:user-macros), [the `nimbleMacros` vignette](https://web.archive.org/web/20250427235758/https://cran.r-project.org/web/packages/nimbleMacros/vignettes/nimbleMacros.html), or `help(buildMacro)` for more information.