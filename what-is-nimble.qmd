...
2. An extensive library of algorithms for models written in NIMBLE, including:
   ...
   - Laplace and adaptive Gauss-Hermite quadrature (AGHQ) approximation (via the `nimbleQuad` package), and
   - an INLA-like nested approximation (via the `nimbleQuad` package).
